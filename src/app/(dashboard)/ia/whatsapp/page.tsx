  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-400 text-sm mt-0.5">Automated reservation & billing messages</p>
      </div>
      <div className="text-center py-20 bg-[#111827] border border-[#1f2937] rounded-2xl">
        ...
        <p className="text-gray-500 text-sm mt-2 max-w-xs mx-auto">
          Send automatic reservation reminders and table-ready notifications via WhatsApp.
        </p>
      </div>
    </div>
  );
